...
The Sender shall include in `Bundle.meta.profile` the value of `http://profiles.ihe.net/RAD/IMR/StructureDefinition/imr-store-multimedia-report-bundle`. The Sender may include other profiles in `Bundle.meta.profile`.
