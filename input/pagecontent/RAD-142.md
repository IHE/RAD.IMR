...
> Note: Some implementations may allow users to modify or supplement observations in a displayed report. For example, the user may re-measure an observed finding. The implementation might allow saving the new measurements as an addendum. The existing report should not be modified.
...
- shall construct the URL for this hyperlink.
    - The URL may be derived from ImagingSelection.endpoint.address referenced in `<imr-ref>`
...
can be translated to the following WADO-RS URL to retrieve DICOM instances

```
http://my.hospital.com/dicomweb/studies/1.2.840.113747.20080222.35738167368358372924306270412538783781/series/1.2.840.113747.20080222.35738167368358372924306270412538783781.1/instances/1.2.840.113747.20080222.35738167368358372924306270412538783781.1.0
```
...
can be translated to the following WADO-RS URL to retrieve rendered DICOM instances

```
http://my.hospital.com/dicomweb/studies/1.2.840.113747.20080222.104120739293836151289003163903631439818/series/1.2.840.113747.20080222.104120739293836151289003163903631439818.200/instances/1.2.840.113747.20080222.104120739293836151289003163903631439818.200.0?presentationSeriesUID=1.2.840.113747.20080222.104120739293836151289003163903631439818.1&presentationUID=1.2.840.113747.20080222.104120739293836151289003163903631439818.1.0
...
can be translated to the following IID URL
