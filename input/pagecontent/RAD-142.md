...
The Display can translate the `<imr-ref>` into the following WADO-RS URL to retrieve rendered DICOM instance
...
The Dispaly can translate the `<imr-ref>` into the following WADO-RS URL to retrieve rendered DICOM instances
...
The Display can translate the `<imr-ref>` into the following IID URL
